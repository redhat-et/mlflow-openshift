...
- In [the oauth spec](https://github.com/hemajv/mlflow-openshift/blob/main/openshift/mlflow-server-deployment.yaml#L21) **provide the service account name** that you created above in step 3.
- In [the oauth spec](https://github.com/hemajv/mlflow-openshift/blob/main/openshift/mlflow-server-deployment.yaml#L21) **provide the service account name** that you created above in step 3.
- In [the spec](https://github.com/hemajv/mlflow-openshift/blob/main/openshift/mlflow-server-deployment.yaml#L71) **provide your PostgreSQL database configurations** (db user, db password, db name, the project/namespace name where it is deployed)
